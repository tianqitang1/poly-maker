...
if not os.path.exists('og_maker/positions/'):
    os.makedirs('og_maker/positions/')
    ...
    async with market_locks[market]:
        try:
            ...
            for detail in deets:
                ...
                fname = 'og_maker/positions/' + str(market) + '.json'
                ...
                # ------- TAKE PROFIT / SELL ORDER MANAGEMENT -------
                    ...
                    # ORIGINAL: Fixed take-profit price (no market trend tracking)
